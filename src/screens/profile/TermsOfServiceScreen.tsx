      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            By accessing or using Are You The One? (“the App”), you agree to be bound by these Terms of Service. If you do not agree, you may not use the App.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            This platform is intended for individuals seeking serious relationships only.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>4. Verification & Safety</Text>
          <Text style={styles.text}>
            To maintain a safe environment, users may be required to:{"\n"}
            • Verify phone number{"\n"}
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            We enforce a zero-tolerance policy for unsafe or harmful behavior.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            You retain ownership of your content, but grant Are You The One? a license to display and use it within the platform.
          </Text>
        </View>

        <View style={styles.section}>
          <Text style={styles.sectionTitle}>7. Subscription & Payments</Text>
          <Text style={styles.text}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            • Remove content{"\n"}
            • Restrict access{"\n\n"}
            At our sole discretion, especially for violations.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            Are You The One? is not liable for:{"\n"}
            • User interactions{"\n"}
            • Emotional outcomes{"\n"}
